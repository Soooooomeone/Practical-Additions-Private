package com.danako.practical_additions.feature.gadget.magnet;

import com.danako.practical_additions.core.PADataComponents;
...
public class AdvancedMagnetMenu extends AbstractContainerMenu {
    ...
    public AdvancedMagnetMenu(int containerId, Inventory playerInventory, ItemStack magnetStack) {
        super(PracticalMenuTypes.ADVANCED_MAGNET_MENU.get(), containerId);
