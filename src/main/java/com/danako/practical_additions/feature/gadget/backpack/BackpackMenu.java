...
public class BackpackMenu extends AbstractContainerMenu {
    ...
    private static NonNullList<ItemStack> readContents(ItemStack stack, int size) {
        ...
        if (!stack.isEmpty()) {
            ItemContainerContents contents = stack.getOrDefault(BackpackContents.BACKPACK_CONTENTS.get(), ItemContainerContents.EMPTY);
    ...
    private void saveContents() {
        ...
        backpackStack.set(BackpackContents.BACKPACK_CONTENTS.get(), ItemContainerContents.fromItems(snapshot));
    }
