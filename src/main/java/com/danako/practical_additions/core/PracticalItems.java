...
import com.danako.practical_additions.feature.gadget.backpack.BackpackItem;
import com.danako.practical_additions.feature.gadget.backpack.BackpackTypes;
import com.danako.practical_additions.feature.gadget.diving_belt.DivingBeltItem;
import com.danako.practical_additions.feature.gadget.magnet.AdvancedMagnetItem;
import com.danako.practical_additions.feature.gadget.magnet.BasicMagnetItem;
import com.danako.practical_additions.feature.gadget.magnet.MagnetFilterData;
import com.danako.practical_additions.feature.gadget.quiver.QuiverContents;
import com.danako.practical_additions.feature.gadget.quiver.QuiverItem;
import com.danako.practical_additions.feature.tool.aoe_tools.ExcavatorItem;
import com.danako.practical_additions.feature.tool.aoe_tools.HammerItem;
import com.danako.practical_additions.feature.tool.aoe_tools.SickleItem;
...
public class PracticalItems {
    ...
    public static final DeferredItem<BlockItem> LEAD_ORE = ITEMS.registerSimpleBlockItem(PracticalBlocks.LEAD_ORE);
    public static final DeferredItem<BlockItem> DEEPSLATE_LEAD_ORE = ITEMS.registerSimpleBlockItem(PracticalBlocks.DEEPSLATE_LEAD_ORE);
    public static final DeferredItem<BlockItem> RAW_LEAD_BLOCK = ITEMS.registerSimpleBlockItem(PracticalBlocks.RAW_LEAD_BLOCK);
    public static final DeferredItem<BlockItem> LEAD_BLOCK = ITEMS.registerSimpleBlockItem(PracticalBlocks.LEAD_BLOCK);
    public static final DeferredItem<BlockItem> DENSE_WEIGHTED_PRESSURE_PLATE = ITEMS.registerSimpleBlockItem(PracticalBlocks.DENSE_WEIGHTED_PRESSURE_PLATE);

    public static final DeferredItem<BlockItem> COBALT_ORE = ITEMS.registerSimpleBlockItem(PracticalBlocks.COBALT_ORE);
    public static final DeferredItem<BlockItem> DEEPSLATE_COBALT_ORE = ITEMS.registerSimpleBlockItem(PracticalBlocks.DEEPSLATE_COBALT_ORE);
    public static final DeferredItem<BlockItem> RAW_COBALT_BLOCK = ITEMS.registerSimpleBlockItem(PracticalBlocks.RAW_COBALT_BLOCK);
    public static final DeferredItem<BlockItem> COBALT_BLOCK = ITEMS.registerSimpleBlockItem(PracticalBlocks.COBALT_BLOCK);

    public static final ToolMaterial LEAD_TOOL_MATERIAL = new ToolMaterial(PracticalTags.Blocks.INCORRECT_FOR_LEAD_TOOL, 220, 5.5F, 1.5F, 14, PracticalTags.Items.LEAD_TOOL_MATERIALS);

    public static final ToolMaterial COBALT_TOOL_MATERIAL = new ToolMaterial(PracticalTags.Blocks.INCORRECT_FOR_COBALT_TOOL, 900, 7.25F, 4.0F, 12, PracticalTags.Items.COBALT_TOOL_MATERIALS);
    ...
    }), 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.1F, PracticalTags.Items.REPAIRS_LEAD_ARMOR, LEAD_ARMOR_ASSET);
    ...
    }), 10, SoundEvents.ARMOR_EQUIP_IRON, 1.0F, 0.0F, PracticalTags.Items.REPAIRS_COBALT_ARMOR, COBALT_ARMOR_ASSET);
    ...
    public static final ToolMaterial EMERALD_TOOL_MATERIAL = new ToolMaterial(PracticalTags.Blocks.INCORRECT_FOR_EMERALD_TOOL, 1124, 8.5F, 3.5F, 12, PracticalTags.Items.EMERALD_TOOL_MATERIALS);
    ...
    }), 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 1.0F, 0.0F, PracticalTags.Items.REPAIRS_EMERALD_ARMOR, EMERALD_ARMOR_ASSET);
    ...
    public static final ToolMaterial LAPIS_TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 175, 6.0F, 1.5F, 30, PracticalTags.Items.LAPIS_TOOL_MATERIALS);
    ...
    public static final ArmorMaterial LAPIS_ARMOR_MATERIAL = new ArmorMaterial(12, Util.make(new EnumMap<>(ArmorType.class), map -> {
        ...
        map.put(ArmorType.BODY, 8);
    }), 30, SoundEvents.ARMOR_EQUIP_GENERIC, 0.0F, 0.0F, PracticalTags.Items.REPAIRS_LAPIS_ARMOR, LAPIS_ARMOR_ASSET);
    ...
    public static final ToolMaterial REDSTONE_TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 64, 10.0F, 3.0F, 22, PracticalTags.Items.REDSTONE_TOOL_MATERIALS);
    ...
    }), 22, SoundEvents.ARMOR_EQUIP_GENERIC, 0.0F, 0.0F, PracticalTags.Items.REPAIRS_REDSTONE_ARMOR, REDSTONE_ARMOR_ASSET);
    ...
    public static final ArmorMaterial KEVLAR_ARMOR_MATERIAL = new ArmorMaterial(24, Util.make(new EnumMap<>(ArmorType.class), map -> {
        ...
        map.put(ArmorType.HELMET, 3);
        map.put(ArmorType.BODY, 8);
    }), 12, SoundEvents.ARMOR_EQUIP_CHAIN, 1.75F, 0.05F, PracticalTags.Items.REPAIRS_KEVLAR_ARMOR, KEVLAR_ARMOR_ASSET);
    ...
    public static final DeferredItem<Item> BASIC_BACKPACK = ITEMS.registerItem("basic_backpack", props -> new BackpackItem(BackpackTypes.BackpackType.BASIC, props.stacksTo(1)));
    public static final DeferredItem<Item> REINFORCED_BACKPACK = ITEMS.registerItem("reinforced_backpack", props -> new BackpackItem(BackpackTypes.BackpackType.REINFORCED, props.stacksTo(1)));
